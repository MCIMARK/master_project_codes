...
drive = "C:/Users/MARCOS/Documents/PARA_ENTRENAMIENTO/VIDEOS"
...
def plot_matrix(X_test,y_test):
    ...
    df_cm = pd.DataFrame(conf_mat, index=['Angry','Happy','Surprised'], columns=['Angry','Happy','Surprised'])
    ...
    plt.savefig(resultados +"matrix_confusion.jpg")
    plt.clf()
    ...
    for j in epoc:
        for k in neur:
            for l in range(cap):
                ...
                DATA_PATH = f'{drive}/NPY3/'
                resultados =f'{drive}/models_3EM/{direccion}'
                sumary = f'{resultados}model_summary.txt'
                model_file = f'{resultados}step_decay_blstm_model.h5'
                caracteristicas = f'Learning cup: step_decay\n Number of epochs: {epocas}\n Learning rate: {learning_rate}\n Number of hidden layers: {l}\n Number of neurons in layer: {k}'
                ...
                def build_model_0(input_shape):
                    ...
                    model = Sequential(name='model_step_decay')
    ...
    for j in epoc:
        for k in neur:
            for l in range(cap):
                ...
                resultados =f'{drive}/models_3EM/{direccion}'
                sumary = f'{resultados}model_summary.txt'
                model_file = f'{resultados}lr_model.h5'
                ...
                def build_model_0(input_shape):
                    ...
                    '''creamos el contenedor de la red LSTM'''
                    model = Sequential(name='model_lr')
    ...
    for j in epoc:
        for k in neur:
            for l in range(cap):
                ...
                resultados =f'{drive}/models_3EM/{direccion}'
                sumary = f'{resultados}model_summary.txt'
                model_file = f'{resultados}scheduler_blstm_model.h5'
                ...
                def build_model_0(input_shape):
                    ...
                    '''creamos el contenedor de la red LSTM'''
                    model = Sequential(name='model_scheduler')
